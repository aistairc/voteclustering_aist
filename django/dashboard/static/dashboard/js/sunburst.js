const area_height = document.getElementById('content-wrapper').clientHeight - 70,
      area_width = document.getElementById('content-wrapper').clientWidth,
      format = d3.format(",d"),
      width = area_height < area_width ? area_height : area_width/1.2,
      radius = width / 6,
      svg_area = document.getElementById('svg_area');
svg_area.style.paddingLeft = `${area_width/2 - width/2}px`;
